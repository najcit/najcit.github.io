...
// METHOD:  polyfit
//
// INPUTS:  xValues[0..(count-1)]
//          yValues[0...(count-1)]
//          count - size of values 
...
//         other => fail.
//----------------------------------------------------
int polyfit(const double* const xValues,
            const double* const yValues,
            ...
            double*             coeffs)
{
    ...
    // This method requires that the count > 
    // (order+1) 
    if (count <= order)
        return -1;
...
[原代码地址](https://github.com/natedomin/polyfit/blob/master/polyfit.c)